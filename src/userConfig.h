...
#define SHOTTIMER 2                // 0 = deactivated, 1 = activated 2 = with scale
...
#define VERBOSE 1                  // 1 = Show verbose output (serial connection), 0 = show less
...
#define BREWMODE 4                 // 1 = Brew by time (with preinfusion); 2 = Brew by weight (from scale)
...
#define PRESSURESENSOR 1           // 1 = pressure sensor connected
#define TEMP_LED 1                 // Blink status LED when temp is in range

// Brew Scale
#define SCALE_SAMPLES 1                     // Load cell sample rate
#define SCALE_CALIBRATION_FACTOR -695.43    // Raw data is divided by this value to convert to readable data
 ...
 */
#define OFFSET      554            // 10% of ADC input @3.3V supply = 102
#define FULLSCALE   3540            // 90% of ADC input @3.3V supply = 922
...
#define INFLUXDB_URL "http://192.168.178.95:8086"            // InfluxDB server address
...
#define INFLUXDB_API_TOKEN "c8qyZbMVT9slYiwQm0rM1iTxZQ3NfV2Ix73Hq1UCs3jecKJrY1ntPI8yXWXicWQWFk_YCwbTCQLqMgULBGhG2A=="
#define INFLUXDB_ORG_NAME "893246146dbb57ee"
#define INFLUXDB_USER ""
#define INFLUXDB_PASSWORD ""
#define INFLUXDB_DB_NAME "2979670c0bf24705"  // InfluxDB bucket name
#define INFLUXDB_INTERVAL 1000     // Send interval in milliseconds
